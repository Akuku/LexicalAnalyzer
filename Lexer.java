/* The following code was generated by JFlex 1.4.3 on 2/3/13 1:29 PM */
 ...
 * on 2/3/13 1:29 PM from the specification file
 * <tt>C:/Users/DRAGON/Documents/CS 411/proj1/toy.flex</tt>
 */
public class Lexer {
    ...
    if (ptr == -1) { // Undefined
        ...
        while(!exit) {
            if (s.symbol.get(ptr) == str.charAt(i)) {
                ...
                // be always be size() (dynamically allocated)
